...
\begin{resume}
    ...
    \begin{list}{$\circ$}{}
        \item Joined \url{https://coala.io} organization. Proposed code enhancement for coala Bears Testing API       %
              \url{https://github.com/coala/cEPs/blob/master/cEP-0027.md}.
        \item Improved automated tests of \url{https://github.com/coala/coala}, an open-source language-independent code analysis tool.
