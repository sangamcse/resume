...
\begin{document}
    ...
    \begin{resume}
        ...
        \section{Education}
            ...
            \begin{itemize}
                \item CGPA of \textbf{7.34}/10 (Jun 2018)
            \end{itemize}
        ...
        \section{Technical \hspace{2mm} Skills}
            ...
            \begin{itemize}
                ...
                \item \textbf{\textsc{Familiar}} - Shell Script, Swift, C\#, JavaScript
            \end{itemize}
            \textbf{Tools/Frameworks}
            \begin{itemize}
                \item \textbf{\textsc{Proficient}} - MySQL, Git, pytest, unittest, coala, \LaTeX, VSCode, Unix-System (Linux \& MacOS)
                \item \textbf{\textsc{Familiar}} - Django, PostgreSQL, PyGame, iOS, Android, OpenGL, AngularJS, NodeJS, Docker, NumPy, Keras, NLTK, matplotlib
            \end{itemize}
        %----------------------------------------------------------------------------------------
        ...
        \section{Relevant \hspace{2mm} Courses}
            ...
            Databases, Automata Theory, Distributed Computing, Software Engineering, Computer Organisation,
        ...
        \section{Selected Projects}
            ...
            \begin{itemize}[leftmargin=*]
                ...
                \item \textbf{\href{http://www.abhiyantran.nitsikkim.ac.in/}{Abhiyantran'17 Website}} : A website for technical festival
                    of NIT Sikkim.
            \end{itemize}
        %----------------------------------------------------------------------------------------
        ...
        \section{Achievements and Awards}
            \begin{itemize}[leftmargin=*]
                \item Mentor at \href{https://codein.withgoogle.com}{Google Code-in 2018}.
        ...
        \section{More}
            Please visit \href{http://www.meetsangamcse.me}{http://www.meetsangamcse.me}
